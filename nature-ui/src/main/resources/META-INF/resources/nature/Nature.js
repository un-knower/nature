...
window.Nature = function Nature()
{
    ...
    this.baseClasspathInfo = {
        ...
        "classes": ["nature.form.FormElement", "nature.form.IconButton", "nature.form.Select", "nature.form.Text", "nature.grid.GridTable", "nature.util.BubbleTip", "nature.util.Processor"]
    };
    this.addClasspath = function(classpathObj)
    {
        ...
        var __resourcesPath = (classpathObj.resourcesPath.startsWith("/") || classpathObj.resourcesPath.startsWith("file:")) ? classpathObj.resourcesPath : Nature.baseInfo.basePath
                + classpathObj.resourcesPath;
