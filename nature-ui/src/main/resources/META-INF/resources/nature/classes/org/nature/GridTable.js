...
Nature.create({
	packages: 'org.nature',
	imports: ['org.nature.form.Text', 'org.nature.util.BubbleTip', 'org.nature.util.Processor', 'org.nature.form.Select', 'org.nature.form.IconButton'],
	className: 'GridTable',
	...
	_init_page_bar: function()
	{
		...
		// 添加刷新按钮
		new org.nature.form.IconButton({
			iconUrl: Nature.sourceMap[Nature.BASE_SOURCE_KEY].resourcesPath + "images/table/refresh.png",
			width: 40,
			height: 22,
		...
		new org.nature.form.IconButton({
			iconUrl: Nature.sourceMap[Nature.BASE_SOURCE_KEY].resourcesPath + "images/table/page-first.png",
			width: 40,
			height: 22,
			click: function()
			{
		...
		new org.nature.form.IconButton({
			iconUrl: Nature.sourceMap[Nature.BASE_SOURCE_KEY].resourcesPath + "images/table/page-prev.png",
			width: 40,
			height: 22,
			click: function()
			{
		...
		// 添加页码输入框
		var pageNumberInput = new org.nature.form.Text({
			helpTip: "",
			width: 80,
			height: 22,
			renderTo: pagination_cell
		...
		new org.nature.form.IconButton({
			iconUrl: Nature.sourceMap[Nature.BASE_SOURCE_KEY].resourcesPath + "images/table/page-next.png",
			width: 40,
			height: 22,
			click: function()
			{
		...
		new org.nature.form.IconButton({
			iconUrl: Nature.sourceMap[Nature.BASE_SOURCE_KEY].resourcesPath + "images/table/page-last.png",
			width: 40,
			height: 22,
			click: function()
			{
	...
	{
		head_cell.processor = new org.nature.util.Processor({
	...
	{
		Nature.checkType(_width, "number", "org.nature.GridTable._create_col");
