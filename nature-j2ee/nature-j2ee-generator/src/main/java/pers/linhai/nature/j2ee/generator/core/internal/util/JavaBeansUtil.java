 ...
 */
package pers.linhai.nature.j2ee.generator.core.internal.util;
...
public class JavaBeansUtil
{
    ...
    public static Method getJavaBeansSetter(IntrospectedColumn introspectedColumn, Context context, IntrospectedTable introspectedTable)
    {
        ...
        method.addBodyLine("addPersistentField(" + introspectedTable.getFullyQualifiedTable().getDomainObjectName() + "Field." + enumFieldName + ".getTableField(), this." + property + ");");
        return method;
    }
