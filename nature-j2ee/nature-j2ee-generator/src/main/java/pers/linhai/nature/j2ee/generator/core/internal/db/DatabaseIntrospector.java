...
import static pers.linhai.nature.j2ee.generator.core.internal.util.JavaBeansUtil.getValidPropertyName;
import static pers.linhai.nature.j2ee.generator.core.internal.util.StringUtility.isTrue;
import static pers.linhai.nature.j2ee.generator.core.internal.util.StringUtility.stringContainsSQLWildcard;
import static pers.linhai.nature.j2ee.generator.core.internal.util.StringUtility.stringContainsSpace;
...
import pers.linhai.nature.j2ee.generator.core.api.JavaTypeResolver;
import pers.linhai.nature.j2ee.generator.core.api.dom.java.FullyQualifiedJavaType;
import pers.linhai.nature.j2ee.generator.core.api.dom.java.JavaReservedWords;
import pers.linhai.nature.j2ee.generator.core.config.ColumnOverride;
import pers.linhai.nature.j2ee.generator.core.config.Context;
import pers.linhai.nature.j2ee.generator.core.config.GeneratedKey;
...
public class DatabaseIntrospector
{
    ...
    private List<IntrospectedTable> calculateIntrospectedTables(TableConfiguration tc, Map<ActualTableName, List<IntrospectedColumn>> columns)
    {
        ...
        for (Map.Entry<ActualTableName, List<IntrospectedColumn>> entry : columns.entrySet())
        {
            ...
            FullyQualifiedTable table = new FullyQualifiedTable(stringHasValue(tc.getCatalog()) ? atn.getCatalog() : null, stringHasValue(tc.getSchema()) ? atn.getSchema() : null, atn.getTableName(),
                tc.getDomainObjectName(), tc.getAlias(), isTrue(tc.getProperty(PropertyRegistry.TABLE_IGNORE_QUALIFIERS_AT_RUNTIME)), tc.getProperty(PropertyRegistry.TABLE_RUNTIME_CATALOG),
