 ...
 * @version 1.0
 */
public class JointQueryException extends RuntimeException
{
     ...
     */
    public JointQueryException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace)
    {
     ...
     * @param cause 
     */
    public JointQueryException(String message, Throwable cause)
    {
        super(message, cause);
        // TODO Auto-generated constructor stub
    }
     ...
     * @param message 
     */
    public JointQueryException(String message)
    {
        super(message);
        // TODO Auto-generated constructor stub
    }
     ...
     * @param cause 
     */
    public JointQueryException(Throwable cause)
    {
        super(cause);
    }
