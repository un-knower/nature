 ...
 * @version 1.0
 */
public class ControllerInterceptProcessDeleteException extends ControllerException
{
     ...
     * @param message 
     */ 
    public ControllerInterceptProcessDeleteException(int errorCode, String message)
    {
