 ...
 * @version 1.0
 */
public class ControllerInterceptProcessSaveException extends ControllerException
{
     ...
     * @param message 
     */ 
    public ControllerInterceptProcessSaveException(int errorCode, String message)
    {
