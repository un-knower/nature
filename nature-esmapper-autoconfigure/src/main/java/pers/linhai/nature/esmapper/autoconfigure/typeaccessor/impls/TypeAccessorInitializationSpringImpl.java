 ...
 * 修改内容:  创建
 */
package pers.linhai.nature.esmapper.autoconfigure.typeaccessor.impls;
...
import pers.linhai.nature.esmapper.core.impls.TypeMapperImpl;
...
public class TypeAccessorInitializationSpringImpl implements TypeAccessorInitialization
{
    ...
    {
        BeanDefinitionBuilder bdb = BeanDefinitionBuilder.genericBeanDefinition(TypeMapperImpl.class);
