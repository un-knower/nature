 ...
 * 修改内容:  创建
 */
package pers.linhai.nature.esmapper.log4jappender.plugins;
...
import pers.linhai.nature.esmapper.log4jappender.hook.IndexAccessShutdownHook;
import pers.linhai.nature.esmapper.log4jappender.model.LogIndex;
import pers.linhai.nature.esmapper.log4jappender.model.LogInfo;
import pers.linhai.nature.esmapper.log4jappender.model.LogMessage;
...
{
    private static TypeMapper<LogInfo> logInfoAccessor;
