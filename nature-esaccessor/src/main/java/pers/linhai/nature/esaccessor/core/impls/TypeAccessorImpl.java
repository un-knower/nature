...
import pers.linhai.nature.esaccessor.exception.TypeAccessorException;
...
import pers.linhai.nature.esaccessor.interfaces.HitCollection;
 ...
 * @version  V100R001C00
 */
public class TypeAccessorImpl<T extends Type> implements TypeAccessor<T>
{
    
    private static final java.util.logging.Logger LOG = java.util.logging.Logger.getLogger(TypeAccessorImpl.class.getName());
