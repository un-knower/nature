 ...
 * 修改内容: <修改内容>
 */
package pers.linhai.nature.esaccessor.model.datatypes.quote;
...
import pers.linhai.nature.esaccessor.core.DataTypeParser;
import pers.linhai.nature.esaccessor.core.impls.ObjectFieldConverterImpl;
import pers.linhai.nature.esaccessor.interfaces.ObjectFieldConverter;
import pers.linhai.nature.esaccessor.model.core.DataTypeCollection;
...
import pers.linhai.nature.esaccessor.model.enumer.Dynamic;
import pers.linhai.nature.esaccessor.model.enumer.Enabled;
...
public class ObjectType<OF extends ObjectField> extends DataType
{
    ...
    public ObjectType(Class<OF> clazz, List<Annotation> annoList)
    {
        try
        {
            ...
            pers.linhai.nature.esaccessor.annotation.datatypes.ObjectField objectField
                = getAnnotation(annoList, pers.linhai.nature.esaccessor.annotation.datatypes.ObjectField.class);
            if(objectField != null)
            {
