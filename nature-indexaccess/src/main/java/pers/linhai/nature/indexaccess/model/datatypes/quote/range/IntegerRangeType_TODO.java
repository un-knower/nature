 ...
 * 修改内容: <修改内容>
 */
package pers.linhai.nature.indexaccess.model.datatypes.quote.range;
...
/**
 * @Description: A range of signed 32-bit integers with a minimum value of -231 and maximum of 231-1. 
 * @author: shinelon
 ...
 * @since: [产品/模块版本]
 */
public class IntegerRangeType_TODO extends DataType
{
