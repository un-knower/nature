 ...
 * 文 件 名:  pers.linhai.nature.indexaccess.util.ResourceUtils.java
...
public abstract class ResourceUtils
{
    ...
    {
        String protocol = url.getProtocol();
        return (URL_PROTOCOL_JAR.equals(protocol) || URL_PROTOCOL_WAR.equals(protocol) || URL_PROTOCOL_ZIP.equals(protocol) || URL_PROTOCOL_VFSZIP.equals(protocol)
