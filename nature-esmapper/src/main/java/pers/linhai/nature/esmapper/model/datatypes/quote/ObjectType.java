...
import pers.linhai.nature.esmapper.core.DataTypeParser;
import pers.linhai.nature.esmapper.core.impls.ObjectFieldConverterImpl;
import pers.linhai.nature.esmapper.interfaces.ObjectFieldConverter;
...
public class ObjectType<OF extends ObjectField> extends DataType
{
    ...
    public ObjectType(Class<OF> clazz, List<Annotation> annoList)
    {
        try
        {
            ...
            pers.linhai.nature.esmapper.annotation.datatypes.ObjectField objectField
                = getAnnotation(annoList, pers.linhai.nature.esmapper.annotation.datatypes.ObjectField.class);
            if(objectField != null)
            {
